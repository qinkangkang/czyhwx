...
public class DictionaryUtil {
	...
	public static void setNameCodeMap(Map<Long, Map<String, String>> nameCodeMap) {
		DictionaryUtil.nameCodeMap = nameCodeMap;
	}

	public static Map<String, String> getOneNameCodeMap(Long classId) {
		return getNameCodeMap().get(classId);
	}
